...
def _mix_rbf_kernel(X, Y, sigmas, wts=None):
    ...
    def r(x): return tf.expand_dims(x, 0)

    def c(x): return tf.expand_dims(x, 1)
...
if __name__ == '__main__':
    # feature input from the three FC layers, respectively.
    # in the shape of [batch_size, hidden dimension]
    # source_features =
    # target_features =
    bandwidths = [2.0, 5.0, 10.0, 20.0, 40.0, 80.0]
    kernel_loss = mix_rbf_mmd2(source_features,
                               target_features, sigmas=bandwidths)
